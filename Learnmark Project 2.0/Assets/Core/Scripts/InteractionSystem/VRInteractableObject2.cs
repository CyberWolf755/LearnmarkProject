...
public class VRInteractableObject2 : MonoBehaviour {
 ...
 protected Transform originalParent;
  ...
  void Awake()
    ...
    {
	    //Empty. Overriden meothod only.
        if(gameObject.GetComponent<HighlightableObject>())
            gameObject.GetComponent<HighlightableObject>().Highlight();
    }
    ...
    public virtual void UnHighlight()
    {
        ...
        if(gameObject.GetComponent<HighlightableObject>())
            gameObject.GetComponent<HighlightableObject>().UnHighlight();
    }
